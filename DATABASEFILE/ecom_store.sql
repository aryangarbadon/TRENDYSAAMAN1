...
(5, 8, 'Sale', '10', 'Trendy', 2, 1),
(6, 14, 'Sale', '65', 'Saaman', 3, 1);
...
(7, 'Hi', 'hi@gmail.com', 'hihihi', 'India', 'Ahmedabad', '1234567890', 'here it is', 'Trendy.png', '::1', '85044058');
...
(1, 'Rules And Regulations', 'rules', '<p>Usage Agreement: Customers agree to the terms by using TRENDYSAMAAN1 Services, which include shopping, mobile applications, and other related services1.\r\nPrivacy: TRENDYSAMAAN1s’s Privacy Notice outlines data handling practices1.\r\nElectronic Communications: Customers consent to electronic interactions with Amazon and acknowledge that all electronic communications satisfy legal requirements1.\r\nCopyright: Content on TRENDYSAMAAN1 Services is protected by copyright laws, and customers must respect these rights1.\r\nTrademarks: TRENDYSAMAAN1’s trademarks cannot be used in a way that causes confusion or discredits the company1.\r\n</p>'),
(2, 'Refund Policy', 'link2', 'Refund Methods and Timelines: For Fulfilled by TRENDYSAMAAN1 (FBA) orders, once the return is received by TRENDYSAMAAN1, refunds are processed promptly. For Seller-Fulfilled orders, refunds occur after the seller notifies TRENDYSAMAAN1 of the return receipt. Prepaid Orders: TRENDYSAMAAN1 Pay Balance: Refunded within 4 hours. Credit Card/Debit Card: Refunded within 5 working days. Net Banking Account (Credited to Bank Account) and UPI Linked Bank Account: Refunded within 5 working days. Pay on Delivery Orders: NEFT to Bank Account: Refunded within 5 working days. TRENDYSAMAAN1 Pay Balance: Refunded within 4 hours. Paper Cheque: Refunded within 10 working days (only in exceptional cases). TRENDYSAMAAN1 Pay Balance: A sum of all balances associated with TRENDYSAMAAN1 Gift Cards in your TRENDYSAMAAN1.in account. If the standard refund time-frame has expired and you haven’t received the refund, contact your credit/debit card issuer or bank. International customers should reach out to Customer Service for refunds. For Seller-Fulfilled orders, sellers authorize refunds for damaged/defective items. TRENDYSAMAAN1 assists in facilitating refunds when the seller notifies them of the return receipts.'),
(3, 'Pricing and Promotions Policy', 'link3', 'TRENDYSAMAAN1’s Pricing & Promotions strategy is a comprehensive approach aimed at delivering value to customers and driving sales. Here’s a revised summary:\r\n\r\nDynamic Pricing: Central to TRENDYSAMAAN1’s strategy is dynamic pricing, which adjusts prices based on market conditions, competitor pricing, and customer behavior. This ensures that TRENDYSAMAAN1’s prices are competitive, fostering customer loyalty and encouraging repeat business.\r\n\r\nBuy Box: A key feature of TRENDYSAMAAN1’s platform is the Buy Box, which sellers aim to win. The Buy Box favors competitively priced items, and securing it can significantly boost a seller’s visibility and sales. Sellers who do not win the Buy Box can still achieve high rankings based on product price and shipping cost.\r\n\r\nPromotions: TRENDYSAMAAN1 utilizes various promotional tactics to create urgency, clear inventory, and improve product visibility. These include time-limited discounts, coupons, and daily deals. Promotions not only motivate purchases but also help products move up the search rankings, leading to more organic sales.\r\n\r\nTechnology and Data: TRENDYSAMAAN1 leverages advanced technology and data analytics to fine-tune its pricing and promotions. The company employs sophisticated algorithms to track and modify prices and promotions, ensuring they remain appealing to customers while also being profitable for sellers.\r\n\r\nCustomer-Centric Approach: TRENDYSAMAAN1’s pricing and promotions are part of a broader customer-centric philosophy. The company strives to provide value through competitive pricing, a wide selection of products, and convenient, fast delivery options. This strategy has helped TRENDYSAMAAN1 become a prominent player in e-commerce, known for offering great deals and a seamless shopping experience.');
